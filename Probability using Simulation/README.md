...
Write a program to estimate the probability of drawing certain balls randomly from a hat. 
...
Next, create an `experiment` function. This function should accept the following arguments:
...
Here is how you would call the `experiment` function based on the example above with 2000 simulations:
